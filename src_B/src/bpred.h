...
/*#define*/ // uint64_t BHT_SIZE = 12;          //ghr
//  /*#define*/ uint64_t MASK = 0x00000FFF; // ((1 << 12)-1);
#define /*uint64_t*/ PHT_SIZE (1 << 12)
...
public:
    ...
    BranchDirection addr;
    BranchDirection pred;
    uint8_t pht[PHT_SIZE];
    uint32_t bht;
    BranchDirection br_dir;
    /**
